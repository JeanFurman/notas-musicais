...
dicionário onde as chaves são as escalas. Se quiser ver todas as escalas implementadas pode user:
...
[List of musical scales and modes](https://en.wikipedia.org/wiki/List_of_musical_scales_and_modes) na wikipedia.

tip: Dica!
    Você pode contrivuir com novas escalas usando a notação inteira:
